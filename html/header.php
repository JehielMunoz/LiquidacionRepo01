...
<head>
	...
	<script>
        ...
        $(function() {            
            ...
            source: nombre,
            change: function(){   // Esto detecta el cambio en el campo de texto. Cuando se usa el autocompletado. Funciona en chrome y firefox, IE NO LO HE PROBADO.
                AsignarId($(this));
            }
            });
        });
	...
	<script>
        ...
        function TraerDatos_Gratificaciones(num,num2){
            ...
            // Tuve que hacer unos cambios para que funcionara. lo voy a explicar en la descripción del commit.
